...
/*
   ...
   * Description: The student marking checkpoint entrance
   */
...
<head>
  ...
  <title>BIT Students Affect Tool - Marking Checkpoint</title>
</head>
      ...
      <div class="col-sm">
        <div class="card shadow" style="width: 36rem;">
          <div class="card-header">
            <h2><i class="fas fa-marker"></i>&nbsp;&nbsp;Mark Checkpoint</h2>
          </div>
          <div class="card-body">
            <form action='<?php echo $self; ?>' method="post">
              <div class="form-group">
                <label for="labName">Checkpoint Name</label>
                <select class="form-control" id="labName" name="labName">
                  <option value='0'>Please select Lab Name</option>
                  <?php foreach ($dataLab['posts_lab'] as $post_lab) : ?>
                  <option value='<?php echo $post_lab->labID; ?>'>
                    <?php echo $post_lab->labName; ?>
                  </option>
                  <?php endforeach; ?>
                </select>
              </div>
              ...
              <div class="form-group">
                <label for="tpwd">Tutor Password</label>
                <input type="password" class="form-control" name="tpwd" id="tpwd" placeholder="Password"
                  required>
              </div>
              <br>
              <button type="submit" name="mark" class="btn btn-primary btn-lg btn-block hand">Mark Checkpoint complete</button>
            </form>
          </div>
        </div>
      </div>
