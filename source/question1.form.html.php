...
<body>
  ...
  <div class="container bg_white">
    <form action='<?php echo $self; ?>' method="post">
      <br>
      <h3>QUESTION <span class='font-g'> 1 / 3 </span>: </h3>
      ...
      <div class="btn-area">
        <p>
          ...
          <input type="submit" class="btn btn-primary btn-lg active hand" name="skip1" value="Skip Question" />&nbsp;&nbsp;
          <input type="submit" class="btn btn-primary btn-lg active hand" name="sendAnswer1" value="Send Answer" id="sendAnswer1" />
        </p><br>
      </div>
    </form>
  </div>
