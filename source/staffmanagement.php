...
/*
   ...
   * Description: The staff main management interface
   */

include 'staff.access.control.php';
...
<head>
  ...
  <title>BIT Students Affect Tool - Reset Student Password</title>
</head>
...
<body>
  ...
  <div class="container bg_white">
    ...
    if(isset($_SESSION['username'])){
      ...
      echo('&nbsp;&nbsp;&nbsp;&nbsp;<a
      href="./securelogout.php">Logout</a>');
    }
    ?>
      ...
      <div class="col-sm">
        <div class="card shadow" style="width: 36rem;">
          <div class="card-header">
            <h2><i class="far fa-registered"></i>&nbsp;&nbsp;Reset Student Password</h2>
          </div>
          <div class="card-body">
            <form action='resetpwd.php' method="post">
              <div class="form-group">
                ...
                <select class="form-control" id="studentName" name="studentName">
                  ...
                  <option value='<?php echo($post_student->studentNumber); ?>'>
              ...
              <button type="submit" name="reset" class="btn btn-primary btn-lg btn-block hand">Reset</button>
            </form>
          </div>
        </div>
      </div>
