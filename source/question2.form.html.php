...
<body>
  ...
  <div class="container bg_white">
    <form action='<?php echo $self; ?>' method="post">
      <br>
      <h3>QUESTION <span class='font-g'> 2 / 3 </span>: </h3>
        ...
        <tr>
          <td>
            <div class="easy-container">
              <p class="easy-hard">Content<br>was<br>all new</p>
            </div>
          </td>
          <td>
            <table class="qtable">
              <caption class="ct table-position">
                <h3>I had a clear plan</h3>
              </caption>
              <caption class="cb table-position">
                <h3>I did not know how to appoache these</h3>
              </caption>
          ...
          <td>
            <div class="easy-container">
              <p class="easy-hard">Content<br>was<br>familiar</p>
            </div>
          </td>
        </tr>
      </table>
      ...
      <div class="btn-area">
        <p>
          ...
          <input type="submit" class="btn btn-primary btn-lg active hand" name="skip2" value="Skip Question" />&nbsp;&nbsp;
          <input type="submit" class="btn btn-primary btn-lg active hand" name="sendAnswer2" value="Send Answer" id="sendAnswer2" />
        </p><br>
      </div>
    </form>
  </div>
